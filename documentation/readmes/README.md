...
3.  **Download Environment Files**: Using the OS specific commands given below, download environment files for all the services.
    ...
    >
    > For detailed instructions on adjusting these values, please consult the **[MentorEd Environment Variable Modification Guide](https://github.com/ELEVATE-Project/mentoring/blob/doc-fix-2.5/documentation/2.6.1/MentorEd-Env-Modification-README.md)**.
...
5. **Create Databases**
    ...
    - **Windows**
        ...
        1. Download `create-databases.bat` Script File:
            ```
            curl -OJL https://github.com/ELEVATE-Project/mentoring/raw/doc-fix-2.5/documentation/2.6.1/native/scripts/windows/create-databases.bat
            ```
...
-   [Mentoring Service](https://github.com/ELEVATE-Project/mentoring/tree/doc-fix-2.5/documentation/latest/postman-collections/mentoring)
-   [User Service](https://github.com/ELEVATE-Project/mentoring/tree/doc-fix-2.5/documentation/latest/postman-collections/mentoring)
-   [Notification Service](https://github.com/ELEVATE-Project/mentoring/tree/doc-fix-2.5/documentation/latest/postman-collections/mentoring)
-   [Scheduler Service](https://github.com/ELEVATE-Project/mentoring/tree/doc-fix-2.5/documentation/latest/postman-collections/mentoring)
